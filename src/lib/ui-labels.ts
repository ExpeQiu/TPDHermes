...
const SKILL_LABELS: Record<string, string> = {
  ...
  speech_skill: "发言稿",
  speech_draft_skill: "领导讲稿",
  video_skill: "短视频脚本",
  video_script_skill: "技术推广导演脚本",
  a4_skill: "A4 一页纸",
  ...
  tech_trend_skill: "技术发展趋势洞察报告",
  model_brand_skill: "技术品牌赋能车型策略",
  brand_name_skill: "技术品牌命名策略报告",
  brand_research_plan: "技术品牌调研计划",
  brand_research_report: "技术品牌调研报告",
  display_concept_skill: "IP技术展具概念策划",
  display_guide_skill: "IP技术展具使用说明书",
  display_project_skill: "IP技术展具制作立项",
  event_plan_skill: "技术推广活动策划",
  interview_qa_skill: "领导采访QA",
  ip_cert_plan: "IP技术认证策划",
  ip_comm_plan: "技术IP传播策划",
  ip_pack_skill: "技术IP包装全案",
  ip_shelf_skill: "技术IP包装货架",
  tech_lockmap_skill: "技术品牌互锁地图",
  tech_pr_skill: "IP技术传播稿",
};
